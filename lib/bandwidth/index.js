...
const getUsedBandwidthByAccount = function (account, now) {
...
module.exports.getUsedBandwidthFromBlock = function(oldBandwidth = 0, oldBandwidthTime = BANDWIDTH_PERIOD, txSize, blockTime) {
  let account = {
    bandwidthTime: oldBandwidthTime,
    bandwidth: oldBandwidth,
  }
  //console.log('aaaaaaaaaaaaaaaaa',blockTime, getUsedBandwidthByAccount(account, blockTime) + txSize, txSize)
