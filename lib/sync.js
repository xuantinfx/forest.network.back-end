            ...
            const syncBlock = async (block) => {
                ...
                if (currentHeight < height) {
                    ...
                    for (let i = 0; i <= blocks.length; i++) {
                        let block = blocks[i];
                        let blockHeight = parseInt(_.get(block, `block.header.height`));
                        console.log(preBlockHeight, blockHeight);
                        if(parseInt(preBlockHeight) >= parseInt(blockHeight)) {
                            console.log('duplicate block', blockHeight);
                        } else {
